...
a1b = P[1,2,1,2]
a1c = P[0,2,5,4]
a1 >> keys(a1a | a1b | a1c | a1b, amp=0.7).every(12, 'offadd', 2)
...
c1 >> gong([0,0,0,var([0,7,4,13])], amp=1 * linvar([0.3,1],43)).every(6, 'stutter', 4)

z1 >> play(' m', amp=0.4, dur=2, hpf=linvar([100,8000],16))
z2 >> play('(-------{be})', amp=0.1)
z3 >> play('x (ooo[llll])( i r l)', amp=0.2, dur=0.5)
z4 >> play('(VVVVVVV[vvv]) ', amp=0.5, hpf=linvar([100,5000],32))
